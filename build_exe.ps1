# Build the Hardspace Finance desktop client into a single .exe.
#   cd C:\Users\caden\hardspace-finance\client
#   powershell -ExecutionPolicy Bypass -File .\build_exe.ps1
# Output: dist\HardspaceFinance.exe  (distribute this single file).

$ErrorActionPreference = "Stop"
python -m pip install --quiet --upgrade pyinstaller
python -m PyInstaller --noconfirm --clean hardspace.spec
Write-Host ""
Write-Host "Built: $(Resolve-Path dist\HardspaceFinance.exe)"
